...
public class TEFurnaceBronze extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Bronze Furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceBronze.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }

...
public class TEFurnaceDiamond extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Diamond Furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceDiamond.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }

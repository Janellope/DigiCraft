...
public class TEFurnaceObsidian extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Obsidian Furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceObsidian.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }

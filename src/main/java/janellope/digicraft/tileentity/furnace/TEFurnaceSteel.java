...
public class TEFurnaceSteel extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "Steel Furnace";
    }
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceSteel.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }

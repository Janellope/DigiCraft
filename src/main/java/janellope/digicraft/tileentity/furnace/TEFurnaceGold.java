...
public class TEFurnaceGold extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    public void update()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                BlockFurnaceGold.setState(this.isBurning(), this.worldObj, this.pos);
            }
        }
